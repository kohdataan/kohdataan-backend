...
module.exports = {
  ...
  down: (queryInterface, Sequelize) => {
    return queryInterface.removeColumn('Users', 'nickname',Sequelize.STRING)
    .then(() => {
      return queryInterface.removeColumn('Users', 'location', Sequelize.STRING)
    })
    .then(() => {
      return queryInterface.removeColumn('Users', 'description', Sequelize.STRING)
    })
    .then(() => {
